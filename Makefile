...
#    Updated: 2026/01/23 17:54:04 by ticharli         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

#REPERTOIRES-----------------------------------------------------------
HEADER = minishell.h
SRC = src/main.c  src/exec.c src/redirections.c src/signals.c \
		...
		src/builtins/env.c src/builtins/export.c src/builtins/unset.c src/heredoc.c \
		src/builtins/exit.c \
